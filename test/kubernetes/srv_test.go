...
var dnsTestCasesSRV = []test.Case{
	...
	},
	{
		...
		Rcode: dns.RcodeSuccess,
		Answer: []dns.RR{
			test.SRV("_c-port._UDP.*.test-1.svc.cluster.local.        5       IN      SRV     0 20 1234 1234-abcd--1.headless-svc.test-1.svc.cluster.local."),
			test.SRV("_c-port._UDP.*.test-1.svc.cluster.local.        5       IN      SRV     0 20 1234 1234-abcd--2.headless-svc.test-1.svc.cluster.local."),
		...
		Extra: []dns.RR{
			test.AAAA("1234-abcd--1.headless-svc.test-1.svc.cluster.local.     5       IN      AAAA    1234:abcd::1"),
			test.AAAA("1234-abcd--2.headless-svc.test-1.svc.cluster.local.     5       IN      AAAA    1234:abcd::2"),
